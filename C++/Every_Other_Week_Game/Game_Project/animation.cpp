...
Animation::Animation(Sprite input_sprite, int input_x, int input_y , float input_scale_x, float input_scale_y, int input_frames, int input_rect_width, int input_rect_height, int input_sheet_width): sprite{input_sprite}, x{input_x}, y{input_y}, scale_x{input_scale_x}, scale_y{input_scale_y}, frames{input_frames}, rect_height{input_rect_height}, rect_width{input_rect_width}, sheet_width{input_sheet_width}, stop{false}
{
