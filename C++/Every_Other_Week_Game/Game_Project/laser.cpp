 ...
 *  Class: laser
 *
 *  Function: change_laser_hitbox
 *
 *  This changes the hitbox location according to the angle at which the laser is moving in
 *
 ****/
 ...
 *  Class: power_laser
 *
 *  Function: change_laser_hitbox (see virtual 'change_laser_hitbox" in 'laser' class)
 *
 *  This changes the hitbox location according to the angle at which the power laser is moving in
 *
 ****/
